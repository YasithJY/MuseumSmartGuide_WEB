...
const MuseumCard = ({ museum, onClick }) => {
  return (
    <div 
      onClick={onClick}
      className="premium-card flex flex-col md:flex-row cursor-pointer bg-[#FCFAF5] dark:bg-stone-800"
    >
      {/* Image */}
      ...
      <div className="p-6 md:w-2/3 flex flex-col justify-between">
        <div className="space-y-3">
          <h3 className="font-heading font-bold text-lg text-primary dark:text-parchment hover:text-gold transition-colors">
            {museum.name}
          </h3>
          ...
          <div className="flex flex-col gap-2 pt-2 border-t border-stone-200/50 dark:border-stone-700/50">
            <div className="flex items-center text-xs text-stone-600 dark:text-stone-400 gap-1.5">
        ...
        <div className="mt-4 flex items-center text-xs font-semibold text-primary dark:text-stone-300 gap-1">
