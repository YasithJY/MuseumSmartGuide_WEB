...
const ExhibitCard = ({ exhibit, onToggleFav, isFav }) => {
  return (
    <div className="premium-card relative group flex flex-col h-full bg-[#FCFAF5]">
      {/* Save Button */}
      {onToggleFav && (
        <button
          onClick={(e) => {
          ...
          className="absolute top-3 right-3 z-10 p-2 rounded-full bg-white/80 hover:bg-white text-stone-700 hover:text-gold shadow-md backdrop-blur-sm transition-all"
        >
      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div className="space-y-2">
          ...
          <h4 className="font-heading font-bold text-base text-primary leading-snug group-hover:text-gold transition-colors">
            {exhibit.title}
          </h4>
        ...
        <Link
          ...
          className="mt-6 inline-flex items-center text-xs font-semibold text-primary group-hover:text-gold transition-colors border-t border-stone-200/80 pt-3"
        >
