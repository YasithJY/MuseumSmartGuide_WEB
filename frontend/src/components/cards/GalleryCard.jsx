...
const GalleryCard = ({ gallery, onClick }) => {
  return (
    <div 
      onClick={onClick}
      className="premium-card relative group cursor-pointer bg-[#FCFAF5] min-h-[300px] flex flex-col justify-between"
    >
      <div>
        {/* Cover Image */}
        ...
        <div className="p-5 space-y-2">
          <h4 className="font-heading font-bold text-base text-primary leading-tight group-hover:text-gold transition-colors">
            {gallery.name}
          </h4>
      ...
      <div className="p-5 border-t border-stone-200/50 flex items-center justify-between text-xs font-semibold text-primary">
