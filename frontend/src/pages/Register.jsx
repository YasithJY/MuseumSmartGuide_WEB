...
import { MdMuseum, MdPerson, MdEmail, MdLock, MdVisibility, MdVisibilityOff } from 'react-icons/md';
    ...
    <div className="min-h-[88vh] flex items-center justify-center px-4 py-12"
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            <h1 className="font-heading font-extrabold text-2xl text-primary uppercase tracking-wide">
              Create Account
            </h1>
            <p className="text-xs text-stone-400 font-semibold tracking-widest uppercase">Museum 150 Smart Guide</p>
          </div>
        ...
        {/* Card */}
        <div className="bg-white border border-stone-200 shadow-xl rounded-2xl p-8 space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="text-xs font-bold text-stone-600 block uppercase tracking-wide">Full Name</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-sm pl-9 pr-4 py-3 rounded-xl border border-stone-200 focus:outline-none focus:ring-2 focus:ring-gold bg-stone-50"
                />
              </div>
            </div>
            ...
            {/* Email */}
            <div className="space-y-1">
              <label className="text-xs font-bold text-stone-600 block uppercase tracking-wide">Email Address</label>
              <div className="relative">
            ...
            {/* Password */}
            <div className="space-y-1">
              <label className="text-xs font-bold text-stone-600 block uppercase tracking-wide">Password</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-sm pl-9 pr-10 py-3 rounded-xl border border-stone-200 focus:outline-none focus:ring-2 focus:ring-gold bg-stone-50"
                />
