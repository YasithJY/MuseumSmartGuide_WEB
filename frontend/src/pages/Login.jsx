      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-xs text-stone-400 font-semibold tracking-widest uppercase">Smart Guide Portal</p>
          </div>
        ...
        <div className="bg-white border border-stone-200 shadow-xl rounded-2xl p-8 space-y-5">
          ...
          <button onClick={() => { enterGuestMode?.(); navigate('/'); }}
            className="w-full border border-stone-200 text-stone-600 hover:bg-stone-50 font-bold py-3 rounded-xl transition-colors uppercase tracking-wider text-xs">
